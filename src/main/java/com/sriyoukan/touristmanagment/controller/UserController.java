...
public class UserController {
    ...
    @Autowired
    public  AnonymousNotificationRepository anonymousNotificationRepository;
    ...
    @PostMapping(value="/anonymousNotification")
    public Boolean postAnonymousNotification(@RequestBody AnonymousNotification anonymousNotification){
        anonymousNotificationRepository.save(anonymousNotification);
        return true;
    }
    @GetMapping(value = "/getAnonymousNotification")
    public List<AnonymousNotification> getAllAnonymousNotification(){
        return anonymousNotificationRepository.findAll();
    }
}
